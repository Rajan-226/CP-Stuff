...
signed main()
{
    ...
    cin.tie(NULL);
#ifndef ONLINE_JUDGE
    freopen("/ATOM/HackerEarth Problems/Disjoint Paths/input.txt", "r", stdin);
    freopen("/ATOM/HackerEarth Problems/Disjoint Paths/output.txt", "w", stdout);
#endif
    int t = 1;
    cin >> t;
    help(t, 50);
